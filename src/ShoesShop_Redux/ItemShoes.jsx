...
import { ADD, CLOSE, VIEW } from './redux/constant';
...
let mapStateToProps = (state) => {
    return {
        selectedShoes: state.selectedShoes
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ItemShoes);